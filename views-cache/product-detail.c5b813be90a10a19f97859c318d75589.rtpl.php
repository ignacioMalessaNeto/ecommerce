                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-category">
                                    <p>Categorias: <?php $counter1=-1;  if( isset($categorys) && ( is_array($categorys) || $categorys instanceof Traversable ) && sizeof($categorys) ) foreach( $categorys as $key1 => $value1 ){ $counter1++; ?> <a href="/category/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a><?php } ?>.
                                </div> 
